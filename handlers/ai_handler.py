...
Отвечай кратко, ясно и по делу. Всегда отвечай на том языке, на котором задан последний вопрос пользователя."""
...
async def cancel_dialog(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    # Используем текст для отмены
    await update.message.reply_text(
        get_text('ai_cancel_dialog', lang))
